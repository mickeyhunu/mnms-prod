                ...
                <header class="community-section-header" id="live-section-header">
                    ...
                    <form class="live-header-search hidden" id="live-header-search" role="search">
                        ...
                        <div class="live-header-search__navigation" role="group" aria-label="검색 결과 이동">
                            <button type="button" class="live-header-search__loading hidden" id="live-search-more-button" aria-live="polite">
                                <span class="live-header-search__loading-spinner" aria-hidden="true"></span>
                                <span class="live-header-search__loading-text">이전 데이터 검색 중</span>
                            </button>
