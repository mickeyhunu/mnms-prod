...
const template = `<main class="piece-chat-page">
  <section class="piece-chat-shell">
    <header class="piece-chat-header"><button id="chat-back" class="piece-chat-back" aria-label="뒤로가기">‹</button><h1 id="chat-title">조각 채팅방</h1><p id="chat-member-count">구성원을 불러오는 중</p><div></div><button id="chat-members" class="piece-chat-icon" aria-label="구성원 보기">☰</button></header>
