...
서로를 존중하고 배려하며 건강한 조각 문화를 만들어주세요!</div><div id="chat-message-list" aria-live="polite"></div></div>
  ...
  <div id="chat-drawer" class="piece-chat-drawer" aria-hidden="true"><button class="piece-chat-drawer-backdrop" data-close-drawer aria-label="닫기" tabindex="-1"></button><aside><header><h2>채팅방 정보</h2><button data-close-drawer aria-label="구성원 보기 닫기" tabindex="-1">×</button></header><h3>참여자</h3><div id="chat-member-list"></div><button id="chat-cancel-participation" class="piece-chat-cancel hidden">참여 취소</button></aside></div>
</main>`;
