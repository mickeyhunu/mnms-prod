    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="admin-workspace" id="admin-workspace">
                <aside class="admin-sidebar" id="admin-sidebar" aria-label="관리자 메뉴">
                ...
                <div id="attendance-comments-section" class="tab-pane hidden">
                    ...
                    <div class="admin-list-toolbar"><p class="admin-list-toolbar__meta">총 <strong id="attendance-comments-total">0</strong>명</p><input type="search" id="attendance-comments-search-input" class="form-control admin-list-toolbar__search" placeholder="이름·작성자·내용 검색" aria-label="출근자 코멘트 검색"></div>
                    <div class="admin-table-container hidden" id="attendance-comments-content"><table class="admin-table admin-attendance-comments-table"><thead><tr><th>출근자</th><th>코멘트</th><th>최근 작성일</th><th>신고</th><th>확인</th></tr></thead><tbody id="attendance-comments-tbody"></tbody></table></div>
                ...
                <div id="users-section" class="tab-pane hidden">
                    ...
                    <div class="admin-table-container hidden" id="users-content">
                        <table class="admin-table"><thead><tr><th id="users-id-header">ID</th><th id="users-login-id-header">아이디</th><th>이름</th><th>닉네임</th><th>연락처</th><th>계정상태</th><th id="users-balance-header">포인트</th><th>가입일</th><th>권한</th><th>회원구분</th><th>관리</th></tr></thead><tbody id="users-tbody"></tbody></table>
                    </div>
                ...
                <div id="posters-section" class="tab-pane hidden">
                    <section class="admin-entry-editor">
                        ...
                        <div class="admin-user-form-grid admin-poster-form">
                            ...
                            <div class="form-group"><label class="form-label" for="posters-form-target-url">클릭 이동 URL</label><input id="posters-form-target-url" class="form-control" type="url" maxlength="2048" placeholder="https://example.com"><small class="help-text">입력하지 않으면 포스터를 클릭해도 이동하지 않습니다.</small></div>
                            <div class="form-group"><label class="form-label" for="posters-form-image-file">포스터 이미지</label><input id="posters-form-image-file" class="form-control" type="file" accept="image/*"><input id="posters-form-image-url" type="hidden"><small id="posters-form-image-help" class="help-text">포스터를 저장할 때 이미지가 함께 업로드됩니다.</small></div>
                        </div>
