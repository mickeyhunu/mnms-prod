...
const AuthAPI = {
    mapAuthUserPayload(payload = {}) {
        return {
            ...
            adPlan: payload.adPlan,
            businessAdPlan: payload.businessAdPlan,
            hasActiveBusinessAd: payload.hasActiveBusinessAd,
            cumulativeAdDays: payload.cumulativeAdDays,
            advertiserLevel: payload.advertiserLevel,
            advertiserLevelEmoji: payload.advertiserLevelEmoji,
            advertiserLevelTitle: payload.advertiserLevelTitle,
