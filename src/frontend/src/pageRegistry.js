                            ...
                            <li class="business-directory-item ad-profile-preview-item">
                                ...
                                <div class="business-directory-main">
                                    <div class="business-directory-meta">
                                        <span class="business-directory-manager" id="ad-profile-preview-manager">🌱 <strong class="business-directory-manager-nickname">담당자</strong> · 0일째 광고중</span>
        ...
        <div class="container">
            ...
            <section class="ad-purchase-layout stamp-purchase-layout" aria-label="스탬프 구매 상품 안내">
                ...
                <article class="ad-payment-card stamp-payment-card hidden" id="stamp-payment-card" aria-label="결제 정보" aria-live="polite">
                    ...
                    <div class="stamp-refund-summary" aria-labelledby="stamp-refund-summary-title">
                        <strong id="stamp-refund-summary-title">청약철회·환불 핵심 안내</strong>
                        <ul>
                            <li>결제내용을 받은 날부터 7일 이내이고 스탬프를 전혀 사용하지 않은 경우 전액 환불됩니다.</li>
                            <li>일부 사용 시 사용분과 보너스 회수분을 반영해 남은 유상 스탬프 금액을 환불합니다.</li>
                            <li>정상적으로 광고 노출이 시작된 사용분은 단순 변심으로 환불·복구되지 않습니다.</li>
                            <li>법정 청약철회와 회사 귀책 환불에는 별도 수수료가 없습니다.</li>
                        </ul>
            ...
            <div class="container ad-management-container">
                ...
                <section class="ad-management-panel ad-activation-panel hidden" aria-labelledby="ad-management-activation-title" id="ad-management-activation-panel">
                    <div class="ad-activation-copy">
                        <h2 id="ad-management-activation-title">업체광고 자동연장 활성화</h2>
                    </div>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="container ad-management-container">
                ...
                <section class="ad-management-panel ad-activation-panel" aria-labelledby="jump-management-title">
                    <div class="ad-management-section-title-row">
                        <div>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="ad-order-history-caption">
                <p>스탬프 결제완료와 결제취소 내역만 최신순으로 확인할 수 있어요. 환불은 <a href="/customer-service">1:1 고객센터</a>에 주문번호와 사유를 접수해주세요.</p>
        ...
        <div class="container">
            ...
            <div class="card create-post-card">
                ...
                <form id="post-form" enctype="multipart/form-data">
                    ...
                    <option value="PIECE">조각게시판</option>
                            ...
                            <div class="piece-field-row">
                                ...
                                <div class="piece-location-selector-wrap">
                                    <div class="piece-location-control-row">
                                        <select id="piece-location-city" class="form-control piece-input" data-piece-label="장소" data-piece-required="true" aria-haspopup="dialog" aria-controls="piece-ad-selector" required>
                                            <option value="" selected>선택</option>
                                        </select>
                                    </div>
...
<main class="main-content">
    ...
    <main class="main-content"><div class="container">
      ...
      <div class="play-tool-content" aria-labelledby="wiki-title">
        <div class="wiki-panel__hero">
          ...
          <h2 id="wiki-title">🍾 화류계 유흥업소 용어사전</h2>
        ...
        <div class="wiki-glossary" aria-label="화류계 유흥업소 용어 카테고리">
  ...
  'alcohol': {
    ...
    <main class="main-content">
      <div class="container">
        ...
        <div class="play-tool-content"><section class="alcohol-calculator card-enter">
  ...
  'terms-policy': {
    template: `<header class="header"><div class="header-container"><a href="/" class="logo"><h1>미드나잇 맨즈</h1></a><nav class="nav" id="navigation"><div class="nav-user"><span class="user-nickname" id="user-nickname"></span><a href="/admin" class="btn btn-secondary btn-sm hidden" id="admin-link">관리자</a><button class="btn btn-outline btn-sm" id="logout-btn">로그아웃</button></div></nav></div></header>
    <main class="main-content terms-policy-page"><div class="container customer-service-page mypage-linked-container"><header class="community-section-header"><div class="community-header-left"><a href="/my-page" class="community-back-link icon-btn icon-btn-square" aria-label="마이페이지로 이동"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m15 18-6-6 6-6"></path></svg></a><span class="community-board-name">약관 및 정책</span></div></header>
    <div class="mypage-linked-content"><section class="terms-policy-card" aria-labelledby="terms-title">
      <div class="terms-hero"><span class="terms-eyebrow">TERMS &amp; POLICIES</span><h2 id="terms-title">미드나잇 맨즈 이용약관</h2><p>회원 유형에 맞는 약관과 모든 회원에게 적용되는 공통 정책을 구분해 안내합니다.</p><div class="terms-meta"><span>시행일 2026. 07. 27.</span><span>최종 업데이트 2026. 07. 27.</span></div></div>
      <nav class="terms-quick-nav" aria-label="약관 바로가기"><a href="#common-terms"><strong>공통</strong><span>모든 회원</span></a><a href="#personal-terms"><strong>일반회원</strong><span>커뮤니티 이용</span></a><a href="#business-terms"><strong>기업회원</strong><span>광고·업체 운영</span></a><a href="#privacy-policy"><strong>개인정보</strong><span>수집·보호</span></a></nav>
      <aside class="terms-summary" aria-label="주요 내용 요약"><div><span class="terms-summary-icon" aria-hidden="true">✓</span><p><strong>가입 및 탈퇴</strong>회원은 언제든 탈퇴를 요청할 수 있습니다.</p></div><div><span class="terms-summary-icon" aria-hidden="true">↻</span><p><strong>스탬프 환불</strong>미사용 구매 건은 결제일부터 7일 이내 신청할 수 있습니다.</p></div><div><span class="terms-summary-icon" aria-hidden="true">!</span><p><strong>이용 제한</strong>법령·권리 침해 또는 운영 방해 시 콘텐츠와 계정이 제한될 수 있습니다.</p></div></aside>

      <section class="terms-group" id="common-terms"><div class="terms-group-heading"><span class="terms-group-number">01</span><div><span class="terms-scope-badge terms-scope-badge--common">공통 적용</span><h2>모든 회원 공통 약관</h2><p>일반회원과 기업회원 모두에게 적용됩니다.</p></div></div>
        <details class="terms-accordion" open><summary><span><b>제1조</b> 목적 및 약관의 적용</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><p>본 약관은 MN컴퍼니(이하 “회사”)가 운영하는 미드나잇 맨즈 서비스(이하 “서비스”) 이용과 관련하여 회사와 회원의 권리·의무 및 책임사항을 정함을 목적으로 합니다.</p><p>회원 유형별 약관과 공통 약관이 충돌하는 경우에는 해당 회원 유형에 관한 별도 조항을 우선 적용합니다.</p></div></details>
        <details class="terms-accordion"><summary><span><b>제2조</b> 계정과 회원의 의무</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>회원은 정확한 정보로 가입하고 계정 공유, 도용 또는 명의 도용을 해서는 안 됩니다.</li><li>아이디와 비밀번호 등 계정 보안을 관리할 책임이 있으며 부정 사용을 발견하면 즉시 회사에 알려야 합니다.</li><li>관계 법령, 본 약관과 운영정책을 준수하고 타인의 권리를 침해하거나 서비스 운영을 방해해서는 안 됩니다.</li></ul></div></details>
        <details class="terms-accordion"><summary><span><b>제3조</b> 서비스 변경 및 이용 제한</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><p>회사는 운영상 필요한 경우 기능을 추가·변경·중단할 수 있으며 원칙적으로 사전에 안내합니다. 긴급 장애, 보안 문제 등 불가피한 사유가 있으면 사후 안내할 수 있습니다.</p><p>법령 위반, 권리 침해, 스팸·사기, 반복적인 운영 방해가 확인되면 게시물 삭제, 기능 제한, 일시 또는 영구 이용 제한 등의 조치를 할 수 있습니다. 회사는 가능한 범위에서 사유와 이의제기 방법을 안내합니다.</p></div></details>
        <details class="terms-accordion"><summary><span><b>제4조</b> 탈퇴, 책임 및 분쟁 해결</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>회원은 언제든 회원 탈퇴를 요청할 수 있으며 회사는 관계 법령과 서비스 정책에 따라 처리합니다.</li><li>천재지변, 외부 연동 장애 등 합리적으로 통제하기 어려운 사유로 발생한 손해에 대해서는 회사의 책임이 제한될 수 있습니다. 회사의 고의 또는 중대한 과실이 있는 경우는 제외합니다.</li><li>분쟁 발생 시 상호 협의를 우선하며 해결되지 않는 경우 대한민국 법령과 관계 법령상 관할 법원에 따릅니다.</li></ul></div></details>
        <details class="terms-accordion"><summary><span><b>제5조</b> 약관의 변경</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><p>회사는 관계 법령을 위반하지 않는 범위에서 약관을 변경할 수 있습니다. 변경 사유, 적용일과 주요 내용을 서비스 공지사항 등에 적용일 전에 안내하며, 회원에게 불리한 중요한 변경은 합리적인 기간을 두고 안내합니다.</p><p>회원은 변경 약관에 동의하지 않을 경우 서비스 이용을 중단하고 탈퇴할 수 있습니다.</p></div></details>
      </section>

      <section class="terms-group" id="personal-terms"><div class="terms-group-heading"><span class="terms-group-number">02</span><div><span class="terms-scope-badge terms-scope-badge--personal">일반회원 전용</span><h2>일반회원 이용약관</h2><p>커뮤니티 참여와 콘텐츠 이용에 적용됩니다.</p></div></div>
        <details class="terms-accordion"><summary><span><b>제1조</b> 커뮤니티 이용</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>회원은 게시글, 댓글 등 자신이 등록한 콘텐츠에 필요한 권리를 보유해야 합니다.</li><li>불법 정보, 혐오·차별·비방, 음란물, 사칭, 사기 유도, 저작권·초상권 침해 콘텐츠를 게시할 수 없습니다.</li><li>신고된 콘텐츠는 내부 기준에 따라 검토하며 필요한 경우 작성자에게 소명 자료를 요청할 수 있습니다.</li></ul></div></details>
        <details class="terms-accordion"><summary><span><b>제2조</b> 콘텐츠의 이용과 관리</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><p>회원이 작성한 콘텐츠의 권리는 회원에게 있습니다. 회원은 서비스 운영·노출에 필요한 범위에서 회사가 콘텐츠를 저장, 복제, 표시할 수 있도록 허용합니다.</p><p>회원은 서비스를 통해 얻은 정보를 회사 또는 권리자의 사전 허락 없이 상업적으로 이용하거나 제3자에게 제공할 수 없습니다.</p></div></details>
        <details class="terms-accordion"><summary><span><b>제3조</b> 신고 및 제재</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><p>회사는 위반의 내용과 반복 정도를 고려해 안내·경고, 콘텐츠 제한, 임시 이용 제한, 영구 이용 제한을 적용할 수 있습니다. 긴급한 권리 침해나 이용자 보호가 필요한 경우 사전 통지 없이 우선 조치할 수 있습니다.</p></div></details>
      </section>

      <section class="terms-group" id="business-terms"><div class="terms-group-heading"><span class="terms-group-number">03</span><div><span class="terms-scope-badge terms-scope-badge--business">기업회원 전용</span><h2>기업회원 이용약관</h2><p>사업자 인증, 업체정보, 광고와 유료서비스에 적용됩니다.</p></div></div>
        <details class="terms-accordion"><summary><span><b>제1조</b> 기업회원 등록과 정보 관리</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>기업회원은 사업자등록증, 영업 관련 증빙 등 회사가 요청하는 자료를 정확하게 제출해야 합니다.</li><li>상호, 대표자, 연락처, 영업 상태 등 등록 정보가 변경되면 지체 없이 수정하거나 회사에 알려야 합니다.</li><li>허위·도용 자료 제출, 휴·폐업 사실 미고지 또는 관련 법령상 필요한 자격 미비가 확인되면 기업회원 승인이나 업체 노출이 제한될 수 있습니다.</li></ul></div></details>
        <details class="terms-accordion"><summary><span><b>제2조</b> 업체정보와 광고 운영</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>광고 소재와 업체정보는 사실에 부합해야 하며 거짓·과장 표시, 제3자의 권리 침해 또는 불법 영업을 포함해서는 안 됩니다.</li><li>회사는 광고 규격, 노출 위치, 심사 기준을 운영정책에 따라 정할 수 있으며 위반 소재는 수정 요청, 노출 보류 또는 중단할 수 있습니다.</li><li>노출 순서와 효과는 이용 환경과 상품 조건에 따라 달라질 수 있으며 회사는 별도로 명시한 경우를 제외하고 특정 성과를 보장하지 않습니다.</li></ul></div></details>
        <details class="terms-accordion" id="stamp-purchase-refund-policy"><summary><span><b>제3조</b> 스탬프 구매·사용 및 환불</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><h3>스탬프의 구분과 사용</h3><ul><li>스탬프는 광고와 관련 유료서비스에 사용하는 전자적 이용권으로, 유상 스탬프와 프로모션으로 지급된 보너스 스탬프로 구분합니다.</li><li>회사는 구매 전에 유상·보너스 수량, 공급가액, 부가가치세, 총 결제금액, 사용조건과 환불조건을 안내합니다.</li><li>스탬프는 유상 스탬프부터 사용된 후 보너스 스탬프가 사용됩니다.</li></ul><h3>청약철회와 환불</h3><ul><li>결제내용을 제공받은 날부터 7일 이내에 청약철회를 신청할 수 있습니다. 스탬프를 사용하지 않았다면 결제금액 전액을 환불합니다.</li><li>일부 사용한 경우 총 결제금액에 ‘잔여 유상 스탬프 ÷ 구매한 전체 유상 스탬프’를 곱해 잔여 유상분을 산정합니다.</li><li>환불 시 남은 보너스 스탬프는 회수하며 이미 사용한 보너스 상당액은 환불 가능 금액 내에서 공제할 수 있습니다. 추가 금액은 청구하지 않습니다.</li><li>표시·광고나 계약내용과 다르게 제공된 경우 관계 법령에서 정한 기간과 방법에 따라 청약철회할 수 있습니다.</li></ul><h3>환불 신청과 처리</h3><ul><li><a href="/customer-service">1:1 고객센터</a>에 주문번호와 환불 사유를 제출해 신청할 수 있습니다.</li><li>회사는 환불 사유와 사용 여부를 확인한 날부터 3영업일 이내 원결제수단으로 취소 또는 환급 절차를 진행합니다.</li><li>중복 결제는 정상 결제 1건을 제외한 중복분 전액을 환불합니다. 시스템 오류로 스탬프나 광고가 제공되지 않으면 정상 제공, 스탬프 복구 또는 미제공분 환불 중 합리적인 방법으로 조치합니다.</li></ul></div></details>
        <details class="terms-accordion"><summary><span><b>제4조</b> 광고 종료 및 기업회원 탈퇴</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>정상적으로 광고 노출이 시작된 뒤 해당 광고에 사용된 스탬프는 단순 변심으로 환불하거나 복구하지 않습니다.</li><li>탈퇴 시 보너스 스탬프는 소멸합니다. 유상 스탬프는 탈퇴 전에 사용하거나 환불을 신청해야 하며 회사는 탈퇴 전에 잔여 수량과 환불 가능 여부를 안내합니다.</li><li>환불 분쟁이나 진행 중인 거래가 있다면 해당 절차가 끝난 뒤 탈퇴를 처리할 수 있습니다.</li></ul></div></details>
      </section>

      <section class="terms-group" id="privacy-policy"><div class="terms-group-heading"><span class="terms-group-number">04</span><div><span class="terms-scope-badge terms-scope-badge--policy">별도 정책</span><h2>개인정보 및 운영정책</h2><p>회원 유형과 관계없이 함께 확인해 주세요.</p></div></div>
        <details class="terms-accordion"><summary><span><b>정책 1</b> 개인정보처리방침</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><p>회사는 「개인정보 보호법」에 따라 서비스 제공에 필요한 범위에서 개인정보를 처리합니다.</p><div class="terms-data-grid"><div><strong>처리 목적</strong><span>가입의사 확인, 본인 인증, 계정 관리, 고객 문의, 부정 이용 방지, 공지 전달</span></div><div><strong>일반회원 항목</strong><span>아이디, 비밀번호, 휴대폰 번호, 닉네임</span></div><div><strong>기업회원 추가 항목</strong><span>상호, 사업자등록번호, 대표자 및 담당자 정보, 사업자·영업 증빙</span></div><div><strong>자동 수집 항목</strong><span>IP주소, 쿠키, 접속일시, 이용기록, 기기정보</span></div><div><strong>보유 기간</strong><span>회원 탈퇴 시까지. 법령상 보존이 필요한 정보는 해당 기간 별도 보관</span></div><div><strong>수정 로그</strong><span>일반 게시글·댓글 수정 로그 3개월, 신고 접수 건의 수정 로그 1년</span></div></div><p>회사는 동의 또는 법적 근거 없이 개인정보를 제3자에게 제공하지 않습니다. 처리 위탁 시 수탁자와 위탁업무를 공개하고 관리·감독합니다.</p></div></details>
        <details class="terms-accordion"><summary><span><b>정책 2</b> 정보주체의 권리와 보호조치</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li>정보주체는 개인정보의 열람, 정정, 삭제와 처리정지를 요구할 수 있습니다. 법령상 보관 의무가 있는 정보는 삭제가 제한될 수 있습니다.</li><li>회사는 접근권한 관리, 주요 정보 암호화, 접속기록 보호, 보안 프로그램 운영 등 안전성 확보조치를 시행합니다.</li><li>쿠키 저장은 브라우저 설정에서 거부할 수 있으며 일부 맞춤형 기능 이용이 제한될 수 있습니다.</li><li>개인정보 문의는 <a href="/customer-service">1:1 고객센터</a>, 침해 상담은 개인정보침해신고센터(118) 또는 개인정보분쟁조정위원회(1833-6972)를 이용할 수 있습니다.</li></ul></div></details>
        <details class="terms-accordion"><summary><span><b>정책 3</b> 커뮤니티 운영정책</span><i aria-hidden="true"></i></summary><div class="terms-accordion-body"><ul><li><strong>금지 콘텐츠:</strong> 불법 정보, 혐오·차별·비방, 음란물, 사칭, 사기 유도, 저작권·초상권 침해 게시물</li><li><strong>제재 절차:</strong> 안내·경고 → 콘텐츠 제한 또는 임시 이용 제한 → 영구 이용 제한</li><li><strong>신고 처리:</strong> 내부 기준에 따라 검토하고 필요한 경우 추가 소명 자료를 요청합니다.</li></ul></div></details>
      </section>
      <div class="terms-contact"><div><strong>약관에 대해 궁금한 점이 있나요?</strong><span>고객센터에서 문의를 남겨주시면 확인 후 답변해 드립니다.</span></div><a href="/customer-service" class="btn btn-primary">1:1 문의하기</a></div>
    </section></div></div></main>
