...
<main class="main-content">
  ...
  'terms-policy': {
    ...
    <div class="mypage-linked-content"><section class="customer-service-card terms-policy-card"><h2>서비스 이용약관</h2><p>본 약관은 MN컴퍼니(이하 “회사”)가 운영하는 미드나잇 맨즈 커뮤니티 서비스(이하 “서비스”)의 이용과 관련하여 회사와 회원의 권리·의무 및 책임사항을 규정합니다.</p><ul><li>회원은 정확한 정보로 가입해야 하며, 계정 공유·도용·명의 도용은 금지됩니다.</li><li>회원은 관련 법령, 본 약관, 커뮤니티 운영정책을 준수해야 합니다.</li><li>회사는 서비스 운영상 필요한 경우 기능 추가·변경·중단을 사전 공지 후 진행할 수 있습니다. 단, 긴급 장애 대응 등 불가피한 경우 사후 공지할 수 있습니다.</li></ul><p>회사는 회원이 등록한 게시물 중 관계 법령 위반, 권리 침해, 서비스 운영 방해, 스팸·광고·사기성 게시물 등에 해당하는 내용을 사전 통지 없이 제한·삭제할 수 있습니다.</p><h2>회원의 권리와 의무</h2><ul><li>회원은 언제든지 회원 탈퇴를 요청할 수 있으며, 회사는 관련 법령에 따라 처리합니다.</li><li>회원은 본인 계정 보안(아이디/비밀번호 관리)에 대한 책임이 있으며, 부정 사용 발견 시 즉시 회사에 알려야 합니다.</li><li>회원은 서비스를 통해 얻은 정보를 회사의 사전 승인 없이 상업적으로 이용하거나 제3자에게 제공할 수 없습니다.</li></ul><h2 id="stamp-purchase-refund-policy">스탬프 청약철회·환불 정책</h2><h3>1. 스탬프의 구분과 사용</h3><ul><li>스탬프는 광고 및 관련 유료서비스에 사용하는 전자적 이용권이며, 대금을 지급해 구매한 유상 스탬프와 프로모션으로 무상 지급된 보너스 스탬프로 구분합니다.</li><li>회사는 구매 전에 상품 구성, 유상·보너스 수량, 공급가액, 부가가치세, 총 결제금액, 사용조건과 환불조건을 안내합니다.</li><li>스탬프는 유상 스탬프부터 사용되고 이후 보너스 스탬프가 사용됩니다.</li></ul><h3>2. 청약철회와 환불</h3><ul><li>회원은 결제내용을 제공받은 날부터 7일 이내 청약철회를 신청할 수 있습니다. 스탬프를 전혀 사용하지 않은 경우 결제금액 전액을 환불합니다.</li><li>일부 사용한 경우 사용된 유상 스탬프를 제외한 잔여 유상 스탬프 금액을 환불합니다. 잔여 유상 스탬프 금액은 VAT를 포함한 총 결제금액에 ‘잔여 유상 스탬프 수 ÷ 구매한 전체 유상 스탬프 수’를 곱해 산정합니다.</li><li>구매 취소 또는 환불 시 해당 구매에 부수해 지급된 남은 보너스 스탬프는 전부 회수합니다. 이미 사용한 보너스가 있으면 환불 가능 금액 범위에서 그 상당액을 공제하되 회원에게 추가 금액을 청구하지 않습니다.</li><li>표시·광고 또는 계약내용과 다르게 제공된 경우에는 관계 법령에서 정한 기간과 방법에 따라 청약철회할 수 있습니다.</li><li>법정 청약철회 기간이 지난 단순 변심 환불은 제한될 수 있습니다. 본 정책은 관계 법령에 따른 회원의 권리를 제한하지 않습니다.</li></ul><h3>3. 광고에 사용된 스탬프</h3><ul><li>회원의 요청에 따라 광고 노출이 정상적으로 시작되면 해당 광고에 차감된 스탬프는 사용 완료된 것으로 봅니다.</li><li>정상적으로 제공된 광고에 사용된 스탬프는 단순 변심으로 환불하거나 복구하지 않습니다.</li><li>회사의 귀책사유 또는 시스템 오류로 광고가 정상 제공되지 않으면 회사는 누락 기간 추가 제공, 사용 스탬프 복구 또는 미제공 부분에 해당하는 금액 환불 중 합리적인 방법으로 조치합니다.</li></ul><h3>4. 환불 신청과 처리</h3><ul><li>회원은 <a href="/customer-service">1:1 고객센터</a>에 주문번호와 환불 사유를 제출하여 환불을 신청할 수 있습니다.</li><li>회사는 환불 사유와 스탬프 사용 여부를 확인한 날부터 3영업일 이내에 원결제수단으로 결제취소 또는 환급 조치를 진행합니다.</li><li>회사가 결제취소를 완료한 뒤 실제 승인취소 또는 입금이 반영되는 시점은 카드사, 은행 및 결제대행사의 처리 일정에 따라 달라질 수 있습니다.</li><li>법정 청약철회 및 회사 귀책사유에 따른 환불에는 환불수수료, 결제대행수수료 또는 위약금을 공제하지 않습니다.</li></ul><h3>5. 중복 결제와 시스템 오류</h3><ul><li>중복 결제 시 회원이 의도한 정상 결제 1건을 제외한 중복분 전액을 수수료 없이 환불하고 중복 지급된 스탬프를 회수합니다.</li><li>결제 후 스탬프가 지급되지 않은 경우 회원의 선택에 따라 스탬프를 정상 지급하거나 결제금액 전액을 환불합니다.</li><li>스탬프가 차감됐지만 광고가 활성화되지 않은 경우 스탬프를 복구합니다. 복구만으로 계약 목적을 달성하기 어려우면 해당 스탬프 상당액을 환불합니다.</li><li>회사의 귀책사유로 광고가 일부 기간 제공되지 않은 경우 누락 기간 추가 제공, 스탬프 복구 또는 미제공 부분에 해당하는 금액 환불 중 합리적인 방법으로 조치합니다.</li></ul><h3>6. 회원 탈퇴</h3><ul><li>탈퇴 시 남은 무상·보너스 스탬프는 소멸하며 복구되지 않습니다.</li><li>유상 스탬프는 탈퇴 전에 사용하거나 본 정책에 따라 환불을 신청해야 합니다. 회사는 탈퇴 완료 전에 잔여 유상·보너스 수량과 환불 가능 여부를 안내합니다.</li><li>회원이 안내를 확인하고 환불 신청 없이 탈퇴를 완료하면 관계 법령상 별도 반환의무가 인정되는 경우를 제외하고 잔여 스탬프는 소멸합니다.</li><li>결제취소 또는 환불 분쟁이 진행 중이면 해당 절차가 끝난 뒤 탈퇴를 처리할 수 있습니다.</li></ul><h2>개인정보처리방침</h2><p>MN컴퍼니(이하 “회사”)는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 권익을 보장하기 위해 다음과 같이 개인정보처리방침을 수립·공개합니다.</p><p>회사는 서비스 제공에 필요한 범위에서만 개인정보를 수집·이용하며, 목적이 변경되는 경우 관련 법령에 따라 별도 동의를 받는 등 필요한 조치를 이행합니다.</p><ul><li>처리 목적: 회원 가입의사 확인, 본인 식별·인증, 계정 관리, 고객 문의 처리, 부정 이용 방지, 공지 전달</li><li>처리 항목: 아이디, 비밀번호, 휴대폰 번호, 닉네임(서비스 이용 과정에서 IP주소, 쿠키, 접속일시, 이용기록, 기기정보가 자동 수집될 수 있음)</li><li>보유 기간: 회원 탈퇴 시까지. 단, 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 별도 보관</li><li>커뮤니티 게시글·댓글 수정 로그 보관: 일반 로그는 수정일로부터 3개월, 신고가 접수된 게시글·댓글의 수정 로그는 수정일로부터 1년 보관</li></ul><p>회사는 정보주체의 동의가 있거나 법령에 근거한 경우를 제외하고 개인정보를 제3자에게 제공하지 않으며, 위탁이 필요한 경우 수탁자·위탁업무를 사전에 고지하고 관리·감독합니다.</p><p>정보주체는 언제든지 개인정보 열람, 정정, 삭제, 처리정지 요구를 할 수 있으며 회사는 관련 법령에 따라 지체 없이 조치합니다. 다만, 법령상 보관의무가 있는 정보는 삭제가 제한될 수 있습니다.</p><ul><li>안전성 확보조치: 접근권한 관리, 비밀번호 등 주요 정보 암호화, 접속기록 보관 및 위변조 방지, 보안 프로그램 운영, 내부관리계획 수립·시행</li><li>쿠키 운영: 맞춤형 서비스 제공을 위해 쿠키를 사용할 수 있으며, 이용자는 브라우저 설정을 통해 쿠키 저장을 거부할 수 있습니다.</li><li>권익침해 구제: 개인정보침해신고센터(국번없이 118), 개인정보분쟁조정위원회(1833-6972) 등을 통해 상담 및 구제를 받을 수 있습니다.</li></ul><p>개인정보 보호책임자 및 문의 창구는 고객센터를 통해 안내하며, 관련 문의에 대해 지체 없이 답변·처리합니다.</p><h2>커뮤니티 운영정책</h2><p>회사는 안전하고 건전한 커뮤니티 환경을 위해 아래 정책을 적용합니다.</p><ul><li>금지 콘텐츠: 불법 정보, 혐오·차별·비방, 음란물, 사칭, 사기·유도, 저작권·초상권 침해 게시물</li><li>제재 절차: 안내/경고 → 게시물 제한 또는 임시 이용제한 → 영구 이용제한</li><li>신고 처리: 접수된 신고는 내부 기준에 따라 검토 후 조치하며, 필요 시 추가 소명 자료를 요청할 수 있습니다.</li></ul><h2>면책 및 분쟁해결</h2><p>회사는 천재지변, 시스템 장애, 외부 서비스 연동 문제 등 불가항력으로 인한 서비스 중단에 대해 책임이 제한될 수 있습니다. 다만, 회사의 고의 또는 중대한 과실이 있는 경우는 예외로 합니다.</p><p>회사와 회원 간 분쟁은 상호 협의를 우선하며, 협의가 어려운 경우 대한민국 법령을 따르고 관할 법원은 관련 법령에 따릅니다.</p><p class="terms-policy-updated">시행일: 2026-07-26</p></section></div></div></main>
