...
async function initDatabase() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS users (
      ...
      profile_introduction VARCHAR(200) NULL,
  ...
  const userColumnDefinitions = [
    ...
    { name: 'profile_introduction', query: "ALTER TABLE users ADD COLUMN profile_introduction VARCHAR(200) NULL AFTER profile_image_url" },
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS business_ads (
      ...
      kakao_talk_id VARCHAR(100) NOT NULL DEFAULT '',
      telegram_id VARCHAR(100) NOT NULL DEFAULT '',
      show_business_address_map TINYINT(1) NOT NULL DEFAULT 0,
      use_visit_verification TINYINT(1) NOT NULL DEFAULT 0,
      use_stamp_event TINYINT(1) NOT NULL DEFAULT 0,
      stamp_event_description VARCHAR(255) NOT NULL DEFAULT '',
      stamp_event_count INT NOT NULL DEFAULT 0,
      ...
      piece_activated_at DATETIME NULL,
      piece_activated_until DATETIME NULL,
      piece_is_active TINYINT(1) NOT NULL DEFAULT 0,
  ...
  const businessAdsColumnMigrations = [
    ...
    { name: 'kakao_talk_id', sql: "ALTER TABLE business_ads ADD COLUMN kakao_talk_id VARCHAR(100) NOT NULL DEFAULT '' AFTER close_hour" },
    { name: 'telegram_id', sql: "ALTER TABLE business_ads ADD COLUMN telegram_id VARCHAR(100) NOT NULL DEFAULT '' AFTER kakao_talk_id" },
    { name: 'show_business_address_map', sql: 'ALTER TABLE business_ads ADD COLUMN show_business_address_map TINYINT(1) NOT NULL DEFAULT 0 AFTER telegram_id' },
    { name: 'use_visit_verification', sql: 'ALTER TABLE business_ads ADD COLUMN use_visit_verification TINYINT(1) NOT NULL DEFAULT 0 AFTER show_business_address_map' },
    { name: 'use_stamp_event', sql: 'ALTER TABLE business_ads ADD COLUMN use_stamp_event TINYINT(1) NOT NULL DEFAULT 0 AFTER use_visit_verification' },
    { name: 'stamp_event_description', sql: "ALTER TABLE business_ads ADD COLUMN stamp_event_description VARCHAR(255) NOT NULL DEFAULT '' AFTER use_stamp_event" },
    { name: 'stamp_event_count', sql: 'ALTER TABLE business_ads ADD COLUMN stamp_event_count INT NOT NULL DEFAULT 0 AFTER stamp_event_description' },
    ...
    { name: 'piece_activated_at', sql: 'ALTER TABLE business_ads ADD COLUMN piece_activated_at DATETIME NULL AFTER activated_until' },
    { name: 'piece_activated_until', sql: 'ALTER TABLE business_ads ADD COLUMN piece_activated_until DATETIME NULL AFTER piece_activated_at' },
    { name: 'piece_is_active', sql: 'ALTER TABLE business_ads ADD COLUMN piece_is_active TINYINT(1) NOT NULL DEFAULT 0 AFTER piece_activated_until' },
    { name: 'daily_jump_remaining', sql: 'ALTER TABLE business_ads ADD COLUMN daily_jump_remaining INT NOT NULL DEFAULT 0 AFTER piece_is_active' },
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS piece_participants (
      post_id BIGINT NOT NULL,
      user_id BIGINT NOT NULL,
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS stamp_histories (
      ...
      action_type ENUM('STAMP_PURCHASE','STAMP_PURCHASE_CANCEL','VISIT_VERIFICATION','SERVICE_BOTTLE_USE','BUSINESS_AD_BASIC','BUSINESS_AD_PLUS','BUSINESS_AD_PREMIUM','ADMIN_ADJUST_ADD','ADMIN_ADJUST_DEDUCT','EXPIRED') NOT NULL,
      amount INT NOT NULL,
      reason VARCHAR(255) NULL,
  ...
  await pool.query(`
    ...
    MODIFY COLUMN action_type ENUM('STAMP_PURCHASE','STAMP_PURCHASE_CANCEL','VISIT_VERIFICATION','SERVICE_BOTTLE_USE','BUSINESS_AD_BASIC','BUSINESS_AD_PLUS','BUSINESS_AD_PREMIUM','ADMIN_ADJUST_ADD','ADMIN_ADJUST_DEDUCT','EXPIRED') NOT NULL
  `);
