...
async function initDatabase() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS stamp_histories (
      ...
      action_type ENUM('STAMP_PURCHASE','VISIT_VERIFICATION','SERVICE_BOTTLE_USE','BUSINESS_AD_BRONZE','BUSINESS_AD_SILVER','BUSINESS_AD_GOLD','ADMIN_ADJUST_ADD','ADMIN_ADJUST_DEDUCT','EXPIRED') NOT NULL,
      amount INT NOT NULL,
      reason VARCHAR(255) NULL,
  ...
  await pool.query(`
    ...
    MODIFY COLUMN action_type ENUM('STAMP_PURCHASE','VISIT_VERIFICATION','SERVICE_BOTTLE_USE','BUSINESS_AD_BRONZE','BUSINESS_AD_SILVER','BUSINESS_AD_GOLD','ADMIN_ADJUST_ADD','ADMIN_ADJUST_DEDUCT','EXPIRED') NOT NULL
  `);
